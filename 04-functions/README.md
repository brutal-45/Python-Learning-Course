...
|------|-------|-------------|
| [basics.py](basics.py) | Function Basics | Definition, calling, docstrings |
| [parameters.py](parameters.py) | Parameters | Args, kwargs, defaults |
| [lambda_functions.py](lambda_functions.py) | Lambda | Anonymous functions, map, filter |
| [decorators_intro.py](decorators_intro.py) | Decorators | Function decoration basics |
...
After completing this module, proceed to [05-modules](../05-modules/) to learn about Python modules.
