...
|------|-------|-------------|
| [hello_world.py](hello_world.py) | First Program | Your first Python program |
| [variables.py](variables.py) | Variables | Variable assignment and naming |
| [operators.py](operators.py) | Operators | Arithmetic, comparison, and logical operators |
| [input_output.py](input_output.py) | I/O Operations | Input and output basics |
| [comments.py](comments.py) | Documentation | Comments and docstrings |
...
After completing this module, proceed to [02-data-types](../02-data-types/) to learn about Python's built-in data types.
