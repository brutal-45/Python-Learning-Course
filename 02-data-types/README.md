...
|------|-------|-------------|
| [numbers.py](numbers.py) | Numeric Types | Integers, floats, complex numbers |
| [strings.py](strings.py) | String Type | String manipulation and methods |
| [lists.py](lists.py) | Lists | Mutable sequences |
| [tuples.py](tuples.py) | Tuples | Immutable sequences |
| [dictionaries.py](dictionaries.py) | Dictionaries | Key-value pairs |
| [sets.py](sets.py) | Sets | Unordered unique collections |
...
After completing this module, proceed to [03-control-flow](../03-control-flow/) to learn about conditional statements and loops.
