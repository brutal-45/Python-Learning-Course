...
|------|-------|-------------|
| [classes_objects.py](classes_objects.py) | Classes & Objects | Basic class definition |
| [inheritance.py](inheritance.py) | Inheritance | Single and multiple inheritance |
| [special_methods.py](special_methods.py) | Special Methods | Dunder methods, operator overloading |
| [advanced_oop.py](advanced_oop.py) | Advanced OOP | Properties, abstract classes |
...
After completing this module, proceed to [07-file-handling](../07-file-handling/) to learn about file operations.
