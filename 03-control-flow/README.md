...
|------|-------|-------------|
| [conditionals.py](conditionals.py) | Conditional Statements | if, elif, else, ternary operator |
| [loops.py](loops.py) | Loops | for loops, while loops, nested loops |
| [loop_control.py](loop_control.py) | Loop Control | break, continue, pass, else clause |
...
After completing this module, proceed to [04-functions](../04-functions/) to learn about functions in Python.
